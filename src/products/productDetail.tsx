...
declare module 'react' {
 ...
 <div className="classic-tabs border rounded px-4 pt-1">
  ...
  <ul className="nav tabs-primary nav-justified" id="advancedTab" role="tablist">
    ...
    <li className="nav-item">
      <a className="nav-link" id="info-tab" data-toggle="tab" href="#info" role="tab" aria-controls="info" aria-selected="false">Information</a>
    </li>
    <li className="nav-item">
  ...
  <div className="tab-content" id="advancedTabContent">
    ...
    <div className="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
      ...
      <div className="media mt-3 mb-4">
        <img className="d-flex mr-3 z-depth-1" src="https://mdbootstrap.com/img/Photos/Others/placeholder1.jpg" width="62" alt="Generic placeholder image"></img>
      ...
      {/* <div>
         <div className="md-form md-outline">
          <textarea id="form76" className="md-textarea form-control pr-6" rows="4"></textarea>
          <label for="form76">Your review</label>
        </div>
        <!-- Name -->
        <div className="md-form md-outline">
          <input type="text" id="form75" className="form-control pr-6"></input>
          <label for="form75">Name</label>
        </div>
        <!-- Email -->
        <div className="md-form md-outline">
          <input type="email" id="form77" className="form-control pr-6"></input>
