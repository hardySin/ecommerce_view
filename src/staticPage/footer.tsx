	...
	<div className="footer-bottom">
		...
		<div className="col-lg-4">
		  ...
		  <div className="cont-details">
			  ...
			  <div className="main-logo"><a href="index.html"><img src={companyLogo} alt=""></img> <span>IT Spares</span></a></div>
  
  <ul className="mt30">
	  <li><span><i className="las la-map-marker"></i></span> No.1, Mohammadpur, Bhikaji Cama Place New Delhi – 110066, India</li>
	  <li><span><i className="las la-envelope"></i></span> <a href="#">customercare@teamcomputers.com</a></li>
	  <hr></hr>
	  <li><span><i className="las la-phone"></i></span>  <a href="#">+1800-102-4200</a>  <br></br>
		  <a href="#">+1800-11-4200</a></li>	
	...
	<div className="row">
				<div className="col-md-4">Team Computers IT Spares. © 2020 | All rights reserved.</div>
